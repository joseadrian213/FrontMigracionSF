...
// import ModalVentasTabla from "./ModalVentasTabla";
...
//   const [sumaIeps, setSumaIeps] = useState(0);
//   const [sumaDescuento, setSumaDescuento] = useState(0);
...
//     toast.success(`Elemento seleccionado: ${element.vta_amecop}`);
//   };
...
//         mutate(data); // Refrescar los datos después de la eliminación, Usa los datos proporcionados directamente, asegurando una actualización inmediata sin una nueva solicitud a la API.
//       })
//       .catch((error) => {
...
//   const btnDelete = () => {
//     const element = {
//       vta_amecop: null, // Asignar un valor adecuado si es necesario
//       vta_caja: caja,
//       vta_tran: folio,
//     };
//     setSelectedElement(element);
...
//     if (totals) {
//       setSumaTotal(totals.total);
//       setSumaImporte(totals.importe);
//       setSumaIva(totals.iva);
//       setSumaIeps(totals.ieps);
//       setSumaDescuento(totals.descuento);
//     }
...
export default function Ventas() {
  ...
  return (
    <div className="mx-auto">
      ...
      <ModalVentasTabla />
      {/* Tabla buscador */}
      {/* <div className="w-full flex justify-center mt-2 mx-auto  overflow-x-auto"> */}
