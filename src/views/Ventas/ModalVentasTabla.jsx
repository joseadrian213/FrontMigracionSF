...
//     console.log(amecopRef.current.value);

//   };

//   const calcularDesc = () => {
//     // getPrice(parseFloat(selectedRow.a_publico),parseFloat(descRef.current.value))
//   };
...
//           //Si no existe o no existe el iva o el ieps le asignamos un valor
//           if (data?.articulos[0]) {
...
//     // // Si el artículo no existe, envía los datos
//     // if (!articuloYaExiste) {
//     //   const respuesta = await enviarDatos(
//     //     "/api/articulos-detventa",
//     //     datosVenta
...
//     //   // mutatePrincipal(); // Actualiza la lista principal después de agregar un nuevo artículo
//     // } else {
//     //   console.error("Transaccion no completada: el artículo ya existe.");
//     //   toast.error("Transaccion no completada: el artículo ya existe.");
//     // }

//     // //Si el amecop no existe en caja y folio que coincidan agreamos el articulo
//     // dataDetVenta?.detventa?.forEach(async (vta) => {
//     //   if (
//     //     datosVenta.vta_amecop !== vta.vta_amecop &&
//     //     datosVenta.vta_caja === vta.vta_caja &&
//     //     datosVenta.vta_tran === vta.vta_tran
...
//     //     // mutate();
//     //     // mutatePrincipal(); // Actualiza la lista principal después de agregar un nuevo artículo
//     //   } else if (datosVenta.vta_amecop === vta.vta_amecop) {
//     //     console.error("Transaccion no completada");
//     //     toast.error("Transaccion no completada: el artículo ya existe.");
//     //   }
//     // });
...
//     }));
//   };
//   /** Se filtran los datos para solo mostrar un unico amecop **/
